...
class dragons:
	...
	coordenadas_x_3 = [692, 687,681,681,679, 673,666,659,645, 640]
	...
	def pedras(time, session, login_token):
		url =  'http://doamobile.com/api/dummy_items/trade_in.json?t='+time+'&r=0&rm_id=277'
		...
		url = 'http://doamobile.com/api/dummy_items/trade_in.json?t='+time+'&s='+result.get('token_md5')+'&r=0&rm_id=277'
...
schedule.every(10).minutes.do(dragons)
